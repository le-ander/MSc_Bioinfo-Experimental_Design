...
########################Final Computations######################################
	...
	print "Proportion of infs", int(((count_inf1)/float(N1))*100), "%"
	print "Proportion of infs", int(((count_inf2)/float(N1))*100), "%"	
	print "Proportion of infs", int(((count_all_inf)/float(N1))*100), "%"
