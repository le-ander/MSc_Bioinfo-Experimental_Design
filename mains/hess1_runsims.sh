...
if [ $THISHOST == cuda10 ]
then
	export CUDA_DEVICE=9
fi

cd /cluster/home/saw112/work/git_group_Hess1/mains

for i in `seq 1 1`; do
	python main_1.py -a 1 -of=results/Hess1/h1_p0_pd -i1 hess1_P0.xml -lc 1 -if=Example_data/Hess1 #&>> results/Hess1/log_files_pd/h1_p0_run1.log
done
