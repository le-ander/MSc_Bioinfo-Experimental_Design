...
for i in `seq 1 1500`; do
	python main_1.py -a 2 -of=results/p53/p53_4xk5b_pd -i1 p53_model_ref.xml p53_model_exp.xml -i2 p53_ref.data p53_4xk5b.data -lc 00 -if=Example_data/p53 &>> results/p53/log_files_pd/p53_4xk5b_pd.log
done
