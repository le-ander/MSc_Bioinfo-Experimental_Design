...
#python main_1.py -a 0 -of=results/Repressilator/repr_server_pd -i1 repressilator.xml -i2 repr_server.data -lc 0 -if=Example_data/Repressilator #&>> results/Repressilator/log_files_pd/repr_server_pd.log
