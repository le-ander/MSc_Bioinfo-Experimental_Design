...
def main():
    template=input_checker(sys.arg)
    ...
    if template==2 or template==3:
        ...
        out_file.write("3) parameter1 parameter2")
        out_file.write("   initial2 initial4")
    ...
    print "Templates succesfully created"
