...
#           print "accepted particles: ",accepted
			accepted = 10000000
			#print "SHAPESAVERESULT",shape(saveResult[0][:][0])
	for mod in range(info_new.nmodels):
		...
		#print "shape parameters", shape(parametersKeepFinal)
		#print "shape params removed", shape(delete(modelTraj[0][0], (1), axis=0))
		#print "shape results removed", shape(delete(modelTraj[0][1], (1), axis=0))
	...
	for mod in range(info_new.nmodels):
		...
		print "maxDistTraj:", maxDistTraj[mod]
		ftheta.append(temp)
		print "ftheta shape", shape(ftheta[mod])
		print "------------------------ "
